...
# ....................................................................
# Get all customers files and merge in one file without Customer Id  
# and date fields
# ....................................................................
...
if deleteDataPrevExec:
	if os.path.isfile(absoluteClusterDataset):
		os.remove(absoluteClusterDataset)
		if verbose:
			print getCurrentDateTimeString() + " - " + absoluteClusterDataset + " deleted successfully!!!"
...
for custFile in customerFiles:
	...
	# Get Day readings
	dayReading = customerDayReading.map(lambda c: [c.READING_00, c.READING_01, c.READING_02,\
	...
	CSVDayReading = dayReading.map(toCSVLine)

	# Get all file data
	data = CSVDayReading.collect()

	# Write result file data and get lines number
	linesCount = writeCSV(absoluteClusterDataset, data, "a")
